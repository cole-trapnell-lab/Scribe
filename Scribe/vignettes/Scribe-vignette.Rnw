...
pheatmap::pheatmap(norm_valid_rdi_res[, ], cluster_rows = F, cluster_cols = F, annotation_names_col = T, border_color = NA)
...
pheatmap::pheatmap(norm_valid_crdi_res, cluster_rows = F, cluster_cols = F, annotation_names_col = T, border_color = NA)
