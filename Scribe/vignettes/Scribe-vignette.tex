...
\hlkwd{plot_causal_network}\hlstd{(res}\hlopt{$}\hlstd{g,} \hlkwc{type} \hlstd{=} \hlstr{'igraph'}\hlstd{,} \hlkwc{layout} \hlstd{= layout_in_circle)}
\end{alltt}
\end{kframe}
...
\begin{kframe}\begin{alltt}
\hlkwd{plot_causal_network}\hlstd{(res}\hlopt{$}\hlstd{g,} \hlkwc{type} \hlstd{=} \hlstr{'arcdiagram'}\hlstd{)}
\end{alltt}
\end{kframe}
