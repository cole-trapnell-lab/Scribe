...
\hlstd{valid_all_cmbns_df} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}\hlkwc{pair} \hlstd{=} \hlkwd{paste}\hlstd{(}\hlkwd{tolower}\hlstd{(all_cmbns}\hlopt{$}\hlstd{Var1),} \hlkwd{tolower}\hlstd{(all_cmbns}\hlopt{$}\hlstd{Var2),} \hlkwc{sep} \hlstd{=} \hlstr{'_'}\hlstd{),} \hlkwc{pval} \hlstd{=} \hlnum{0}\hlstd{)}
...
\hlstd{valid_all_cmbns_df} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}\hlkwc{pair} \hlstd{=} \hlkwd{paste}\hlstd{(}\hlkwd{tolower}\hlstd{(}\hlkwd{as.character}\hlstd{(neuron_network[,} \hlnum{1}\hlstd{])),} \hlkwd{tolower}\hlstd{(}\hlkwd{as.character}\hlstd{(neuron_network[,} \hlnum{2}\hlstd{])),} \hlkwc{sep} \hlstd{=} \hlstr{'_'}\hlstd{),} \hlkwc{pval} \hlstd{=} \hlnum{0}\hlstd{)}
...
\hlstd{pheatmap}\hlopt{::}\hlkwd{pheatmap}\hlstd{(norm_valid_rdi_res[, ],} \hlkwc{cluster_rows} \hlstd{= F,} \hlkwc{cluster_cols} \hlstd{= F,} \hlkwc{annotation_names_col} \hlstd{= T,} \hlkwc{border_color} \hlstd{=} \hlnum{NA}\hlstd{)}
\end{alltt}
\end{kframe}
...
\hlstd{pheatmap}\hlopt{::}\hlkwd{pheatmap}\hlstd{(norm_valid_crdi_res,} \hlkwc{cluster_rows} \hlstd{= F,} \hlkwc{cluster_cols} \hlstd{= F,} \hlkwc{annotation_names_col} \hlstd{= T,} \hlkwc{border_color} \hlstd{=} \hlnum{NA}\hlstd{)}
\end{alltt}
\end{kframe}
